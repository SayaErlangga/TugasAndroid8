...
interface DataListener1 {
    fun onDataReceived1(dataUsername: String, dataPassword: String)
}
/**
...
class LoginFragment : Fragment() {
    ...
    private lateinit var dataListener1: DataListener1
    ...
    override fun onAttach(context: Context) {
        ...
        try {
            dataListener1 = context as DataListener1
    ...
    override fun onCreateView(
        ...
        button.setOnClickListener {
            if(username.text.toString().isEmpty()){
                ...
                dataListener1.onDataReceived1(dataUsername, dataPassword)
            }
